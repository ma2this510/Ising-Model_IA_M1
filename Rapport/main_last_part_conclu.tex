...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.5\linewidth]{latent.jpg}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.5\linewidth]{triple.jpg}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.5\linewidth]{evoltution T = 1.00.jpg}
	\caption{convergence des fonction de coûts à T = 1.00}
	\label{fig:T1}
\end{figure}
\begin{figure}[h]
	\centering
	\includegraphics[width=0.5\linewidth]{evoltution T = 4.00.jpg}
